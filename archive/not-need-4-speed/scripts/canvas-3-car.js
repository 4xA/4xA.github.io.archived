...
function Car(topSpeed, speed, acceleration) {
  ...
  this.changeSpeed = function() {
    ...
    else if (newSpeed > this.topSpeed) this.speed = this.topSpeed;
  ...
  this.steer = function() {
    ...
    if (
      (this.steeringWheelAngle >= 90 && this.steerRight) ||
  ...
  this.drawSpeedMarks = function(canvas, ctx) {
    ...
    for (var i = 0; i < marks; i++) {
      ...
      if (i === 0) ctx.rotate((Math.PI / 180) * 45);
      else if (i === 1);
      else if (i === 2) ctx.rotate((Math.PI / 180) * -45);
      else if (i === 3) ctx.rotate((Math.PI / 180) * -90);
      else if (i === 4) ctx.rotate((Math.PI / 180) * 225);
      else if (i === 5) ctx.rotate((Math.PI / 180) * 180);
